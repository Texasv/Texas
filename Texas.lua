...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SRC-Texas/Files_Texas/main/File_Bot/commands.lua") 
...
if tonumber(user_id) == tonumber(929566528) then  
var = true  
...
local UserName = (data.username_ or "@kk33ii")
...
local Texas_Msg = ''  
if msgs < 100 then 
Texas_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
Texas_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
Texas_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
Texas_Msg = 'متفاعل' 
elseif msgs < 1200 then 
Texas_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
Texas_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
Texas_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
Texas_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
Texas_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
Texas_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
Texas_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
Texas_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
Texas_Msg = 'رب التفاعل'  
end 
return Texas_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝘴𝘰𝘳𝘶𝘤𝘦 𝑇𝐸𝑋𝐴𝑆𖠲.")  
...
--------------------------------------------------------------------------------------------------------------
function SourceTexas(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,Texas_Msg) 
return false  
end 
if text then    
...
os.execute('wget https://raw.githubusercontent.com/Texasv/Texas/main/Texas.lua')
...
{{text = '⋄︙SoUrCe Texas.', url="t.me/kk33ii"}},
}
...
send(msg.chat_id_, msg.id_,'⋄︙ عدد الكروبات الان ~ { '..#group..' }'..Texask..''..Texas..'\n⋄︙ الان عدد الكروبات الحقيقي ~ { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n⋄︙العضو ↫ ['..result.title_..'](t.me/'..(username or 'kk33ii')..')'
status  = '\n⋄︙تم ترقيته مطور'
...
usertext = '\n⋄︙العضو ↫ ['..data.first_name_..'](t.me/'..(data.username_ or 'kk33ii')..')'
status  = '\n⋄︙تم ترقيته مطور'
...
local Texas1_Msg = database:get(bot_id.."Texas1:Add:Filter:Rp2"..text..msg.chat_id_)   
if Texas1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'⋄︙العضو ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'kk33ii')..') \n⋄︙'..Texas1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if Texas_Msg and not Special(msg) then  
local Texas_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Texas_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⋄︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n⋄︙["..Texas_Msg.."] \n")
else
send(msg.chat_id_,0,"⋄︙العضو : {["..data.first_name_.."](T.ME/kk33ii)}\n⋄︙["..Texas_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⋄︙عذرا يا » {["..data.first_name_.."](t.me/kk33ii)}\n⋄︙الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
keyboard.inline_keyboard = {
{
{text = '⋄ معرفة المزيد ؟',url="https://t.me/kk33ii"},
},
}
local msg_id = msg.id_/2097152/0.5
...
database:sadd(bot_id.."Texas:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."Texas:blocname"..msg.chat_id_)
...
if name_MRoMr then 
names_MRoMr = database:smembers(bot_id.."Texas:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."Texas:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."Texas:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."Texas:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."Texas:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."Texas:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function oMr_mroMr_new(mroMr1,mroMr2)
if mroMr2 and mroMr2.first_name_ then 
if mroMr2.first_name_:match("(.*)"..database:get(bot_id.."Texas:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."Texas:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mroMr_nnn = database:get(bot_id.."Texas:nump"..msg.chat_id_) or 5
local mroMr_nnn2 = database:get(bot_id.."Texas:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mroMr_nnn2) == tonumber(mroMr_nnn) or tonumber(mroMr_nnn2) > tonumber(mroMr_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."Texas:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⋄︙عزيزي >>["..mroMr2.username_.."](https://t.me/"..(mroMr2.username_ or "kk33ii")..")\n⋄︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."Texas:teh"..msg.chat_id_).."} بجانب اسمك\n⋄︙عدد المحاولات المتبقيه {"..(tonumber(mroMr_nnn) - tonumber(mroMr_nnn2)).."}")
end
end
end
end
...
local TexasChengName = database:get(bot_id.."Texas:Cheng:Name"..data.id_)
if not data.first_name_ then 
if TexasChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..TexasChengName..']')
database:del(bot_id.."Texas:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if TexasChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."Texas:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local TexasChengUserName = database:get(bot_id.."Texas:Cheng:UserName"..data.id_)
if not data.username_ then 
if TexasChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..TexasChengUserName..']')
database:del(bot_id.."Texas:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if TexasChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."Texas:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local TexasChengPhoto = database:get(bot_id.."Texas:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if TexasChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."Texas:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if TexasChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."Texas:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)  
...
Text = [[
┌─────── 𝐌𝐑 ───────┐
⋄︙*𝘸𝘦𝘭𝘤𝘰𝘮𝘦 𝘵𝘰 𝘴𝘰𝘶𝘳𝘤𝘦 𝑇𝐸𝑋𝐴𝑆𖠲*
    ┈┈┈┈┈┈┈┈┈┈┈┈┈┈
⋄︙[𝑇𝐸𝑋𝐴𝑆𖠲 𝘵𝘦𝘢𝘮](http://t.me/KK55L)
    ┈┈┈┈┈┈┈┈┈┈┈┈┈┈
⋄︙[𝘪𝘯𝘧𝘰𝘳𝘮𝘢𝘵𝘪𝘰𝘯 𝑇𝐸𝑋𝐴𝑆𖠲](https://t.me/kk33ii)
    ┈┈┈┈┈┈┈┈┈┈┈┈┈┈
⋄︙[𝘥𝘦𝘷𝘦𝘭𝘰𝘱𝘦𝘳](http://t.me/KK33L)
    ┈┈┈┈┈┈┈┈┈┈┈┈┈┈
⋄︙[𝘵𝘸𝘴 𝘵𝘦𝘢𝘮](http://t.me/kk33lbot)
└─────── 𝐌𝐑 ───────┘
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'*⋄︙بواسطه ↫*['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'kk33ii')..') \n*⋄︙تم قفـل ↫ الدردشه*\n*⋄︙الايدي ↫* `'..msg.sender_user_id_..'`')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(929566528) then  
...
function(arg,data) 
usertext = '\n*⋄︙المستخدم ↫* ['..data.first_name_..'](t.me/'..(data.username_ or 'kk33ii')..')'
...
if result.id_ == tonumber(929566528) then
send(msg.chat_id_, msg.id_, "*⋄︙سنفر لا يمكنك حظر مطور السورس* \n")
return false 
end
...
usertext = '\n*⋄︙المستخدم ↫* ['..result.title_..'](t.me/'..(username or 'kk33ii')..')'
status  = '\n*⋄︙تم حظره عام من المجموعات*'
texts = usertext..status
...
if userid == tonumber(929566528) then
send(msg.chat_id_, msg.id_, "*⋄︙سنفر لا يمكنك حظر مطور السورس* \n")
return false 
end
...
local UserName = (b.username_ or "SRC-Texas")
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⋄︙العضــو ~ ['..data.first_name_..'](t.me/'..(data.username_ or 'kk33ii')..')'
...
database:set(bot_id.."Texas1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."Texas1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"*⋄︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."Texas1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."Texas1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."Texas1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."Texas1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"*⋄︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."Texas1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."Texas1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."Texas1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."Texas1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"*⋄︙ارسل الكلمه الان*")  
database:set(bot_id.."Texas1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."Texas1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."Texas1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Texas1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."Texas1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."Texas1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."Texas1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Texas1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."Texas1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n*⋄︙قائمة المنع* \n*⊶─────≺⋆≻─────⊷*\n"
for k,v in pairs(list) do  
local Texas_Msg = database:get(bot_id.."Texas1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." ~ {"..Texas_Msg.."}\n"    
end  
if #list == 0 then  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'*⋄︙بواسطه ↫* ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'kk33ii')..') \n*⋄︙تـم تفعيـل الحـمايه* ')  
end,nil)   
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n⋄︙العضو ~ ['..result.title_..'](t.me/'..(text1[3] or 'kk33ii')..')'..'\n⋄︙تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'['..Texas_Msg[math.random(#Texas_Msg)]..']') 
return false
end
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:Texas:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n*⋄︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id.."botss:Texas:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:Texas:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:Texas:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:Texas:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"*⋄︙تم حذف الرد من ردود المتعدده*")
database:del(bot_id..'botss:Texas:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:Texas:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:Texas:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:Texas:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:Texas:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:Texas:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:Texas:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:Texas:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:Texas:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:Texas:List:Rd:Sudo")
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🖨┇𝘴𝘰𝘳𝘶𝘤𝘦 𝑇𝐸𝑋𝐴𝑆𖠲.',url="t.me/kk33ii"}},
}
local msg_id = msg.id_/2097152/0.5
...
if database:get(bot_id.."kk33ii:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
database:set(bot_id.."botss:Texas:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:Texas:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"*⋄︙ارسل الان الكلمه لحذفها*")
end
if text then  
local test = database:get(bot_id.."botss:Texas:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:Texas:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:Texas:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:Texas:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:Texas:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:Texas:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:Texas:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:Texas:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:Texas:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:Texas:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:Texas:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:Texas:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:Texas:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:Texas:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:Texas:Add:Rd:Sudo:Text2"..text)   
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'kk33ii')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
Texasdx(msg.chat_id_, msg.id_, '⋄︙ايدي المجموعة ~ ( '..msg.chat_id_..' )\n⋄︙عدد الادمنيه ~ ( *'..data.administrator_count_..' )*\n⋄︙عدد المحظورين ~ ( *'..data.kicked_count_..' )*\n⋄︙عدد الاعضاء ~ ( *'..data.member_count_..' )*\n', 'md') 
end 
...
{
{text = '𝑇𝐸𝑋𝐴𝑆𖠲 𝘊𝘏𝘈𝘕𝘕𝘌𝘓', url="t.me/kk33ii"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
Texas = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Texas)
...
--------------------------------------------------------------------------------------------------------------
SourceTexas(data.message_,data)
plugin_Texas(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local TexasAbot = database:get(bot_id.."Texas1:Add:Filter:Rp2"..text..result.chat_id_)   
if TexasAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⋄︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n⋄︙["..TexasAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local Texas1_Msg = database:get(bot_id.."Texas1:Add:Filter:Rp2"..text..result.chat_id_)   
if Texas1_Msg then    
send(msg.chat_id_, msg.id_,"⋄︙"..Texas1_Msg)
